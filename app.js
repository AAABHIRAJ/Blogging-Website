...
mongoose.connect('mongodb+srv://admin-abhiraj:Test123@cluster0.wojuy.mongodb.net/postsDB');
    ...
    Post.find((err, foundPosts) => {
        if(!err){
            foundPosts.forEach((post) => {
                ...
                if(_.lowerCase(post.postTitle) === _.lowerCase(requiredTitle)){
...
app.get("/", (req, res) => {
    Post.find((err, foundPosts) => {
        res.render("home", {homeData : homeStartingContent, posts : foundPosts});
    });
